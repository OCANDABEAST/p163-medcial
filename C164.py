...
root.configure(background="#3ec4ed")

label_planet = Label(root, text="Planet : ", bg="#3ec4ed")
label_planet_name = Label(root,font=("courier",18,"bold"),bg="#3ec4ed")
label_planet_image = Label(root, bg="#e3c727", highlightthickness=5, borderwidth=2,relief=SOLID)
label_planet_gravity_radius = Label(root,font=("castellar"),bg="#3ec4ed")
label_planet_info = Label(root,font=("courier",10, "bold"),bg="#3ec4ed",wrap=500)
